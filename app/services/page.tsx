...
export default function ServicesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    submissionData.append("service_needed", formData.service_needed)
    submissionData.append("message", formData.message)
    
    productImages.forEach((image, index) => {
      submissionData.append(`M07_cycle_image[${index}]`, image.file)
    })
    
    warrantyImages.forEach((image, index) => {
      submissionData.append(`M07_warranty_card_photo[${index}]`, image.file)
    })
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full border-purple-200 dark:border-yellow-700 focus:border-yellow-500 focus:ring-yellow-500 rounded-lg h-12 px-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    required
                  >
